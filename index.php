...
<html lang="en">
  <head>
    ...
    <title>GROWING A SUSTAINABLE FUTURE </title>
    <style>
        body{
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="farmer_login.php">LOGIN For Farmer</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="customer_login.php">LOGIN For Consumer</a>
              </li>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text"></p>
        <a href="farmer_login.php" class="btn btn-primary"> NEW REGISTER/ SIGNUP </a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text"></p>
        <a href="customer_login.php" class="btn btn-primary"> NEW REGISTER/ SIGNUP </a>
      </div>
    </div>
  </div>
 </div>
